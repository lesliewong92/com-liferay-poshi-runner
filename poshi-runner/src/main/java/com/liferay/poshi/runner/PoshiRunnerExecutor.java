...
public class PoshiRunnerExecutor {
	...
	public PoshiRunnerExecutor(Element element) {
		_historyNode = new PoshiExecutionHistoryNode(element);
	}
	...
	public void parseElement(Element element) throws Exception {
		...
		for (Element childElement : childElements) {
			...
			_historyNode.insert(childElement);
	...
	public void runFunctionExecuteElement(Element executeElement)
		...
		_historyNode = _historyNode.getLastChildNode();
	...
	private PoshiExecutionHistoryNode _historyNode;

...
public class PoshiRunnerExecutor {
	...
	public void runIfElement(Element element) throws Exception {
		...
		if (condition) {
			...
			// _syntaxLoggerHandler.updateStatus(ifThenElement, "pass");
...
/*
					_syntaxLoggerHandler.updateStatus(
						elseIfThenElement, "pass");
 */
	...
	public void runWhileElement(Element element) throws Exception {
		...
		for (int i = 0; i < maxIterations; i++) {
			...
			// _syntaxLoggerHandler.updateStatus(thenElement, "pass");
